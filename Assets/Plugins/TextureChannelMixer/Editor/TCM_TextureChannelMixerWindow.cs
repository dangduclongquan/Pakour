            ...
            scrollPosition = EditorGUILayout.BeginScrollView(scrollPosition);
            {
                ...
                EditorGUILayout.BeginHorizontal();
                {
                    ...
                    for (int i = 0; i < referenceTextures.Count; ++i)
                    {
                        ...
                        {
                            GUILayout.Label(referenceTextures[i] != null ? referenceTextures[i].width + "x" + referenceTextures[i].height : "");
                            EditorGUILayout.BeginHorizontal();
                            {
                            ...
                            DrawConnectionNodes(i, imageSize + 8);
                        }
                ...
                GUILayout.BeginHorizontal();
                {
                    ...
                    GUILayout.BeginVertical(GUILayout.Width(imageSize));
                    {
                        ...
                        GUILayout.BeginVertical("Box");
                        {
                            Rect r = GUILayoutUtility.GetRect(imageSize, imageSize);
                            GUI.DrawTexture(r, transparencyImage, ScaleMode.ScaleToFit);
                            GUI.DrawTexture(r, resultTexture, ScaleMode.ScaleToFit);
                            //GUILayout.Label(resultTexture, GUILayout.Height(imageSize), GUILayout.Width(imageSize));
                        ...
                        GUILayout.BeginHorizontal(GUILayout.Width(imageSize));
                        GUILayout.FlexibleSpace();
                        autoSize = GUILayout.Toggle(autoSize, "Auto size");
                        GUILayout.FlexibleSpace();
                        GUILayout.EndHorizontal();
                        GUI.enabled = !autoSize;
                        GUILayout.BeginHorizontal(GUILayout.MaxWidth(imageSize + EditorGUIUtility.standardVerticalSpacing * 4));
                        {
